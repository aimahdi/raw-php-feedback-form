...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($password)) {
        ...
        if (strlen($password) < 8) {
            $passwordError = 'Password must be 8 digit';
        }
...
function registerUser($name, $email, $password)
{
    ...
    if (file_exists('all_users.json')) {
        $users = json_decode(file_get_contents('all_users.json'), true);
    } else {
        $users = [];
    }
    ...
    file_put_contents('all_users.json', json_encode($users, JSON_PRETTY_PRINT));
                        ...
                        <div class="mt-10 mx-auto w-full max-w-xl">
                            <form class="space-y-6" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>"
                                ...
                                <div>
                                    ...
                                    <span class="text-red-500 text-xs italic"><?php echo $nameError; ?></span>
                                ...
                                <div>
                                    ...
                                    <span class="text-red-500 text-xs italic"><?php echo $emailError; ?></span>
                                </div>
                                ...
                                <div>
                                    ...
                                    <span class="text-red-500 text-xs italic"><?php echo $passwordError; ?></span>
                                </div>
                                ...
                                <div>
                                    ...
                                    <span
                                        class="text-red-500 text-xs italic"><?php echo $confirmPasswordError; ?></span>
                                </div>
