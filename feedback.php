...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($id == null) {
        $errorMessage = 'Please share a valid feedback url';
    }
        ...
        <div class="relative flex min-h-screen flex-col justify-center overflow-hidden bg-gray-50 py-6 sm:py-12">
            ...
            <div
                ...
                <div class="mx-auto max-w-xl">
                    <?php if ($errorMessage): ?>
                        <span class="text-red-500 text-xs italic"><?php echo $errorMessage; ?></span>

                    <?php elseif ($success): ?>
                        <span class="text-red-500 text-xs italic"><?php echo "Feedback submitted successfully"; ?></span>
                    <?php else: ?>
                        <div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
                            <div class="mx-auto w-full max-w-xl text-center">
                                <h1
                                    ...
                                    TruthWhisper</h1>
                                <h3 class="text-gray-500 my-2">Want to ask something or share a feedback to <?= $name ?>?
                                </h3>
                            </div>
