...
$sharableURL = $protocol . "://" . $host . '/feedback.php?id=' . $loggedUserId;
...
foreach ($feedbacks as $feedback) {
    ...
    $testId = (int) $feedback['id'];
    if ($testId === $loggedUserId) {
    ...
    <header class="bg-white">
        <nav class="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
            ...
            <div class="hidden lg:flex lg:flex-1 lg:justify-end">
                <span class="text-sm font-semibold leading-6 text-gray-900"><?= $name ?></span>
            </div>
        </nav>
            ...
            <div
                ...
                <div class="mt-6 flow-root">
                    <div class="-my-6 divide-y divide-gray-500/10">
                        <div class="py-6">
                            <span
                                class="-mx-3 block rounded-lg px-3 py-2.5 text-base font-semibold leading-7 text-gray-900 hover:bg-gray-50"><?= $name
                                    ?></span>
                        </div>
                    </div>
                </div>
            ...
            <div class="relative max-w-7xl mx-auto">
                <div class="flex justify-end">
                    <span class="block text-gray-600 font-mono border border-gray-400 rounded-xl px-2 py-1">Your
                        feedback form link: <strong><?= $sharableURL ?></strong></span>
                </div>
